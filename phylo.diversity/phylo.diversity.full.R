...
# Calculates, given a phylogeny and information regardng the groups of the species in the phylogeny,
# how the diversity has changed through time

# phy       - the phylogeny of interest of class 'phylo'
# groups    - a data frame where first column "Species" contains all of the species included in 'phy'. The second column "Group" 
#             gives the affiliation of that species
# number.of.partitions - how many times to calculate diversity over the course of the phylogeny
# diversity.index - specify the diversity indices to be used. Can be any used by the 'diversity' function
#		    in the package 'vegan'


# Returns a data frame of the age brackets, the diversity indices, and the individual numbers
# through time for each group
...
output <- phylo.diversity(phy,groups)
